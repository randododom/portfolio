...
import AboutMain from "../../../public/images/general/about/aboutIntro3.jpeg";
import { easeInOut, motion } from "framer-motion";

function Intro() {
  const line1 = "transformez vos";
  const line2 = "idées en projets";
      ...
      <div className="flex justify-center mt-[8vh]">
        <div className="w-[85%] sm:w-[70%] lg:w-[65%] flex justify-center items-center flex-col">
          ...
          <div className="min-h-[30vh] lg:min-h-[65vh] w-full sm:w-[80%] lg:w-[60%] mt-[-3.3vh] md:mt-[-5vh] lg:mt-[-6vh]">
            ...
            >
              ...
              >
                <Image
                  src={AboutMain}
                  alt="securité image informatique citation"
                  className="w-full"
                  placeholder="blur"
                  ref={imageRef}
                />
          ...
          >
            ...
            />
            <Paragraph text="- Steve Jobs" className="text-right mt-2" />
          </motion.div>
        </div>
      </div>
    </section>
