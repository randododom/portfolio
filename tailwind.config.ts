  ...
  theme: {
    extend: {
      ...
      colors: {
        lightBg: "#EDF4FA",
        lightText: "#4A6A8A",
        lightText80: "rgba(74, 106, 138, 0.8)",
        lightText60: "rgba(74, 106, 138, 0.6)",
        lightText20: "rgba(74, 106, 138, 0.2)",
        darkBg: "#0B0F1A",
        darkText: "#B0C3D1",
        darkText80: "rgba(176, 195, 209, 0.8)",
        darkText60: "rgba(176, 195, 209, 0.6)",
        darkText20: "rgba(176, 195, 209, 0.2)",
        accent: "#708CA0",
      },
      screens: {
        xs: "480px",
    ...
    plugin(({ addBase, theme }: { addBase: any; theme: any }) => {
      addBase({
        ...
        ".scrollbar.scrollLight::-webkit-scrollbar-thumb": {
          backgroundColor: "rgba(74, 106, 138, 0.8)",
        },
        ".scrollbar.scrollDark::-webkit-scrollbar-thumb": {
          backgroundColor: "rgba(176, 195, 209, 0.8)",
        },
      });
    }),
  ],
